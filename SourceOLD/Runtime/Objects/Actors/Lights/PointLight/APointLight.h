...
public:
    APointLight() = default;
    APointLight(const vec3& _color, const vec3& _position, const PointLightDistance& _distance);
    APointLight(const vec3& _color, const vec3& _position, const float _distance, const float _linear, const float _quadratic);
